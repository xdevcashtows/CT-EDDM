...
export default function PackingSlips() {
  ...
  return (
    <PageLayout {...layoutProps}>
      <div className="packing-slips-stack space-y-6">
        <div>
          <h2 className="text-2xl font-semibold text-gray-900 mb-2">Process EDDM Routes</h2>
          <p className="text-sm text-gray-600">
            Upload the USPS combined EDDM PDF, merge optional Do Not Deliver addresses, and generate facing slips ready to download.
          </p>
        </div>
